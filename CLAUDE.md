...
- **報告前にURL存在確認必須**: `gh api repos/KazuyaMurayama/freelance-compass/contents/PATH?ref=BRANCH` でステータス200確認
- push完了後のみURL生成。404を出したら即訂正＆原因1行報告

---

## 11. ドキュメント命名・日付ルール（v2.0 / 2026-06-03 改訂）
...
## 15. コンテキスト管理（自動圧縮対策 / Compact Instructions）
